...
const navItems = [
    ...
    { path: '/library', icon: BookOpen, label: 'Ngân hàng câu hỏi', mobileHide: true },
    ...
    { path: '/reports', icon: BarChart2, label: 'Báo cáo', mobileHide: true },
];
...
export default function SidebarLayout({ children, onLogout }) {
    ...
    return (
        <div className="flex h-screen bg-slate-100 overflow-hidden">
            ...
            <aside
                className={clsx(
                    'bg-white border-r border-slate-200 flex flex-col shadow-sm shrink-0 transition-transform duration-300 z-40',
            ...
            >
                ...
                <div className="h-16 flex items-center px-5 border-b border-slate-100 shrink-0">
                    <div className="flex items-center gap-2.5">
                        ...
                        <div>
                            <span className="font-extrabold text-lg text-slate-900 tracking-tight leading-none block">Plicker</span>
                    ...
                    {navItems.map(item => (
                        <NavLink
                            ...
                            className={({ isActive }) => clsx(
                                item.mobileHide ? 'hidden md:flex' : 'flex',
                                'items-center gap-3 px-3 py-2.5 rounded-xl font-medium text-sm transition-all',
                                isActive
            ...
            <main className="flex-1 overflow-hidden flex flex-col min-w-0">
                ...
                <div className="md:hidden flex items-center gap-3 px-4 py-3 bg-white border-b border-slate-200 shrink-0">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-extrabold text-base text-slate-900 tracking-tight">Plicker</span>
                    </div>
                    {activeSession && (
